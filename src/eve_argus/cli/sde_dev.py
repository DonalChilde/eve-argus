...
from eve_argus.helpers.sde_typed_dicts_to_file import (
    make_typed_dict,
...
# eve-argus sde dev dict-sig ~/projects/tmp/sde-download-test/sde-3081406-jsonl -f ~/projects/tmp/sde-download-test/sde-3081406-dict-sig.json -b 3081406
