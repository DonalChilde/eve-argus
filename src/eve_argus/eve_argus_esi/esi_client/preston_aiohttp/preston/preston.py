"""Forked from https://github.com/Celeo/Preston to replace requests with aiohttp."""
...
class Preston:
    ...
    def _retry_request(
        ...
        **kwargs,
        ...
        """Tries to make a request with retries.
    ...
    def _get_path_for_op_id(self, op_id: str) -> str | None:
    ...
    def post_path(self, path: str, path_data: dict | None, post_data: Any) -> dict:
    ...
    def delete_path(self, path: str, path_data: dict | None) -> dict:
    ...
    def delete_op(self, op_id: str, path_data: dict | None) -> dict:
