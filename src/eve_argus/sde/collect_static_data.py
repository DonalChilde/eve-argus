...
# from eve_static_data.models import static_data_td_3081406 as SDTD
...
# def collect_blueprints(access: SdeAccessProtocol) -> SD.Blueprints:
#     """Collect all blueprints from the static data.

#     Returns:
#         Blueprints: The collected blueprints.
#     """
#     result = SD.Blueprints.from_static_data(
#         access.jsonl_iter(SdeFileNames.BLUEPRINTS),  # pyright: ignore[reportArgumentType]
...
#     access: SdeAccessProtocol, *, localized: str, only_published: bool
# ) -> SD.Categories:
...
#     """
#     categories = SD.Categories.from_static_data(
#         access.jsonl_iter(SdeFileNames.CATEGORIES),  # pyright: ignore[reportArgumentType]
#         localized=localized,
#         sde_info=collect_sde_info(access),
...
#     if only_published:
#         categories.data = {
#             cat_id: cat for cat_id, cat in categories.data.items() if cat.published
#         }
#     return categories
...
# def collect_type_materials(access: SdeAccessProtocol) -> dict[int, SD.TypeMaterial]:
...
#     """
#     type_materials: dict[int, SD.TypeMaterial] = {}
...
#         type_materials_obj = SD.TypeMaterial.from_td(type_materials_td)
...
#             continue
#         type_obj = SD.EveType.from_td(type_td)
